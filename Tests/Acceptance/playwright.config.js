...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      testIgnore: 'specs/checkout-logged-in.spec.js',
    },
    {
      // The one spec that needs an authenticated frontend user - depends on "login" so
      // that setup project runs first and produces the storageState file below.
      name: 'e2e-logged-in',
      testMatch: 'specs/checkout-logged-in.spec.js',
      dependencies: ['login'],
      use: {
