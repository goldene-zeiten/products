...
cat > "${INSTANCE_PATH}/composer.json" <<EOF
{
    ...
    "repositories": [
        {"type": "path", "url": "${ROOT_DIR}/packages/*/*", "options": {"symlink": true, "versions": {"goldene-zeiten/products-api-client": "1.0.0", "goldene-zeiten/products-core": "1.0.0", "goldene-zeiten/products-search": "1.0.0", "goldene-zeiten/products-recently-viewed": "1.0.0", "goldene-zeiten/products-wishlist": "1.0.0", "goldene-zeiten/products-credit-points": "1.0.0", "goldene-zeiten/products-voucher": "1.0.0", "goldene-zeiten/products-watermark": "1.0.0", "goldene-zeiten/products-shipping-ups": "1.0.0", "goldene-zeiten/products-payment-paypal": "1.0.0", "goldene-zeiten/products-payment-stripe": "1.0.0"}}},
