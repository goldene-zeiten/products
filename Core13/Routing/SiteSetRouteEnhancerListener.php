...
namespace GoldeneZeiten\Products\Core13\Routing;
 ...
 * goldene-zeiten/products set by reading the very same route-enhancers.yaml the set ships
 * for 14.1+, so there is a single source of truth for both supported core versions.
 */
#[AsEventListener]
final class SiteSetRouteEnhancerListener
{
    private const SET_NAME = 'goldene-zeiten/products';
    private const ROUTE_ENHANCERS_FILE = 'EXT:products/Configuration/Sets/Products/route-enhancers.yaml';
