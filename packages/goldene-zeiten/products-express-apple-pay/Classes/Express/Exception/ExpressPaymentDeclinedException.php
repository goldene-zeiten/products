...
namespace GoldeneZeiten\Products\Express\ApplePay\Express\Exception;

/**
 * Thrown when the processor did not approve the Apple Pay token, so no order must be created. The confirm
