...
return [
    ...
    'columns' => [
        ...
        'shipping_provider' => [
            'label' => 'LLL:EXT:products/Resources/Private/Language/locallang_tca.xlf:tx_products_domain_model_order.shipping_provider',
            'config' => [
                'type' => 'input',
                'readOnly' => true,
            ],
        ...
        'shipping_option' => [
            'label' => 'LLL:EXT:products/Resources/Private/Language/locallang_tca.xlf:tx_products_domain_model_order.shipping_option',
            'config' => [
                'type' => 'input',
                'readOnly' => true,
            ],
        ...
        'shipping_label' => [
            'label' => 'LLL:EXT:products/Resources/Private/Language/locallang_tca.xlf:tx_products_domain_model_order.shipping_label',
            'config' => [
                'type' => 'input',
                'readOnly' => true,
            ],
        ...
        'handling_fee_total' => [
            'label' => 'LLL:EXT:products/Resources/Private/Language/locallang_tca.xlf:tx_products_domain_model_order.handling_fee_total',
            'config' => [
                'type' => 'number',
                'readOnly' => true,
            ],
        ...
        'deposit_total' => [
            'label' => 'LLL:EXT:products/Resources/Private/Language/locallang_tca.xlf:tx_products_domain_model_order.deposit_total',
            'config' => [
                'type' => 'number',
                'readOnly' => true,
            ],
        ...
        'gift_message' => [
            'label' => 'LLL:EXT:products/Resources/Private/Language/locallang_tca.xlf:tx_products_domain_model_order.gift_message',
            'config' => [
                'type' => 'text',
                'readOnly' => true,
            ],
